...
const solarSystem = [
    ...
    console.log(solarSystem[4].moons[1]);
    ...
    solarSystem.ringSystem = false
    solarSystem.moons = ["Charon"]
    ...
    for (const planet in solarSystem) {
                if(solarSystem.ringSystem === true){
    ...
    let moons = parseInt(system.jupiter.satellites) + system.saturn.satellites + system.uranus.satellites + system.neptune.satellites
    console.log(moons)
    ...
    let diff = (system.jupiter.velocity * system.jupiter.mass) - (system.pluto.velocity * system.pluto.mass)
    console.log(diff)
